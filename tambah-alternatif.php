			...
			<?php endif; ?>			
				...
				<form action="tambah-alternatif.php" method="post">
					...
					<div class="field-wrap clearfix">					
						...
						<input type="text" name="nama_alternatif" cols="30" value="<?php echo $nama_alternatif; ?>">
					</div>			
					
					<h3>Nilai Kriteria</h3>
					<?php
					$query = $pdo->prepare('SELECT id_kriteria, kode, ada_pilihan, nama_kriteria FROM kriteria ORDER BY urutan_order ASC');			
					$query->execute();
