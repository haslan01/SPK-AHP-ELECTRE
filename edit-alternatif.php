		...
		<div class="main-content the-content">
			...
			<?php else: ?>				
				...
				<form action="edit-alternatif.php?id=<?php echo $id_alternatif; ?>" method="post">
					...
					<?php
					$query2 = $pdo->prepare('SELECT nilai_alternatif.nilai AS nilai, kriteria.kode AS kode, kriteria.nama_kriteria AS nama_kriteria, kriteria.id_kriteria AS id_kriteria, kriteria.ada_pilihan AS jenis_nilai 
							...
							<div class="field-wrap clearfix">					
								...
								<?php if(!$kriteria['jenis_nilai']): ?>
									...
									<select name="kriteria[<?php echo $kriteria['id_kriteria']; ?>]" >
										<option value="<?php echo ($kriteria['nilai']) ? $kriteria['nilai'] : 0; ?>"><?php echo ($kriteria['nilai']) ? $kriteria['nilai'] : 0; ?></option>	
