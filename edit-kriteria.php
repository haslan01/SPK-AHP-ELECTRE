...
?>
	...
	<div class="container clearfix">
		...
		<div class="main-content the-content">
			<h1>Input <?php echo $nama_kriteria; ?></h1>
			...
			<?php else: ?>				
				...
				<form action="edit-kriteria.php?id=25" method="post">
					...
					<input type="text" name="nama_kriteria" value="<?php echo $nama_kriteria; ?>" hidden>
					</div>
					<div class="field-wrap clearfix">					
						<label>Nilai <span class="red">*</span></label>
						<input type="number" name="bobot" value="<?php echo $bobot; ?>" step="1" min=1>
					</div>					
					<div class="field-wrap clearfix">					
						<!-- <label>Urutan Order</label> -->
						<input type="number" name="urutan_order" value="<?php echo $urutan_order; ?>" min=0 hidden>
					</div>
					<div class="field-wrap clearfix">					
						<!-- <label>Cara Penilaian</label> -->
						<select name="jenis_nilai" id="jenis-nilai" hidden>
					...
					<div class="field-wrap clearfix">
						<button type="submit" name="submit" value="submit" class="button">Next</button>
					</div>
				</form>
