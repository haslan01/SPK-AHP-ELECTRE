...
require_once('template-parts/sidebar-ranking.php');
...
<!-- STEP 2. NILAI KRITERIA AHP (W) ==================== -->
<!-- <?php include'koneksi.php';?>
<h3> Step 2: Nilai Input Kriteria (W)</h3>	
<table class="pure-table pure-table-striped">
    <tr>
        <th>Kode Kriteria</th>
        <th>Nama Kriteria</th>
	...
	<?php 
	$query = mysqli_query($conn,"select * from pv_kriteria ORDER BY kode");
